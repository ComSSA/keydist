...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SKU', fields ['name']
        db.create_unique(u'keys_sku', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'SKU', fields ['name']
        db.delete_unique(u'keys_sku', ['name'])
