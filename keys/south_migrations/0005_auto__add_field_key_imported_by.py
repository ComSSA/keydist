...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Key.imported_by'
        db.add_column(u'keys_key', 'imported_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='imported_by', to=orm['accounts.KeydistUser']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Key.imported_by'
        db.delete_column(u'keys_key', 'imported_by_id')
