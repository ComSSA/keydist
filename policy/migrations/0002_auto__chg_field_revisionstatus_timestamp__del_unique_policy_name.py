...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Policy', fields ['name']
        db.delete_unique(u'policy_policy', ['name'])


        # Changing field 'RevisionStatus.timestamp'
        db.alter_column(u'policy_revisionstatus', 'timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

    def backwards(self, orm):

        # Changing field 'RevisionStatus.timestamp'
        db.alter_column(u'policy_revisionstatus', 'timestamp', self.gf('django.db.models.fields.DateTimeField')())
        # Adding unique constraint on 'Policy', fields ['name']
        db.create_unique(u'policy_policy', ['name'])
