...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Revision.timestamp'
        db.add_column(u'policy_revision', 'timestamp',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'RevisionStatus.timestamp'
        raise RuntimeError("Cannot reverse this migration. 'RevisionStatus.timestamp' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'RevisionStatus.timestamp'
        ...
        # Deleting field 'Revision.timestamp'
        db.delete_column(u'policy_revision', 'timestamp')
