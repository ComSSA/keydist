...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Revision.change'
        db.add_column(u'policy_revision', 'change',
                      self.gf('django.db.models.fields.CharField')(default='Old change.', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Revision.change'
        db.delete_column(u'policy_revision', 'change')
