...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Key.imported_at'
        db.add_column(u'keys_key', 'imported_at',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 7, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Key.imported_at'
        db.delete_column(u'keys_key', 'imported_at')
