...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RevisionStatus.notes'
        db.alter_column(u'policy_revisionstatus', 'notes', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'RevisionStatus.notes'
        db.alter_column(u'policy_revisionstatus', 'notes', self.gf('django.db.models.fields.TextField')())
    ...
    models = {
        ...
        u'policy.revision': {
            ...
            'change': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
        ...
        u'policy.revisionstatus': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'notes': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
